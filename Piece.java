...
public class Piece{
    ...
    public ArrayList<Integer> Pawn_Offsets(int u,HashMap<String, JButton> hsh) {

    	ArrayList<Integer> _Offsets = new ArrayList<Integer>();



    	if (hsh.get(Integer.toString(u)).getIcon().toString() == "a/pawn.png") {

    		if (hsh.get(Integer.toString(u-8)).getIcon().toString() == "a/blank.png") {

    			_Offsets.add(u - 8);

    			if (hsh.get(Integer.toString(u-16)).getIcon().toString() == "a/blank.png" && u > 48 && u < 57) {
    		...
    		if (hsh.get(Integer.toString(u-9)).getIcon().toString() != "a/blank.png" && hsh.get(Integer.toString(u-9)).getIcon().toString().contains("1")) {

    			_Offsets.add(u - 9);

    		}
    		if (hsh.get(Integer.toString(u-7)).getIcon().toString() != "a/blank.png" && hsh.get(Integer.toString(u-7)).getIcon().toString().contains("1")){

    			_Offsets.add(u - 7);

    		}

    	} else if (hsh.get(Integer.toString(u)).getIcon().toString() == "a/pawn1.png") {

    		if (hsh.get(Integer.toString(u+8)).getIcon().toString() == "a/blank.png") {

    			_Offsets.add(u + 8);

    			if (hsh.get(Integer.toString(u+16)).getIcon().toString() == "a/blank.png" && u > 8 && u < 17) {
