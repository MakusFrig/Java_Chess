				...
				if (_Selected_Piece == null) {
					...
					for (int u = 9; u < 65; u ++) {
						...
						if (_Places.get(Integer.toString(u)) == _Selected_Piece) {
							...
							if (i == (u + 8)) {
								if (_Places.get(Integer.toString(i)).getIcon().toString() == "a/blank.png") {
									ImageIcon _Blank = new ImageIcon("a/blank.png");
								...
								if (u < 17 && u > 8) {
									System.out.println(_Places.get(Integer.toString(i)).getIcon().toString());
									System.out.println(_Places.get(Integer.toString(i-8)).getIcon().toString());
									if (_Places.get(Integer.toString(i)).getIcon().toString() == "a/blank.png" && _Places.get(Integer.toString(i-8)).getIcon().toString() == "a/blank.png") {
										ImageIcon _Blank = new ImageIcon("a/blank.png");
										_Places.get(Integer.toString(i)).setIcon(_Selected_Piece.getIcon());
										_Places.get(Integer.toString(u)).setIcon(_Blank);
								...
								if (!_Places.get(Integer.toString(i)).getIcon().toString().contains("1") && _Places.get(Integer.toString(i)).getIcon().toString() != "a/blank.png") {
									ImageIcon _Blank = new ImageIcon("a/blank.png");
									_Places.get(Integer.toString(i)).setIcon(_Selected_Piece.getIcon());
									_Places.get(Integer.toString(u)).setIcon(_Blank);
